...
# ==========================================================
    ...
    # '기이하게 뒤틀린'의 경우 뒤에 조사를 붙이지 않음으로써 문맥 최적화
    if st.session_state.eye_color == "역안":
...
# ==========================================================
    ...
    if st.session_state.selected_choice_1 == 1:
        ...
        st.write("")
        st.write('"안녕하세요."')
        st.write("오히려 상대 쪽에서 더 놀란 듯 합니다. 보이지 않는 것에 부딪친 것처럼, 눈 앞의 사람은 깜짝 놀라 몸을 굳힙니다. 그리고 이내,")
        st.write("")
        st.write('"......아, 놀랐잖아."')
        st.write("")
